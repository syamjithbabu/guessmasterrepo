            ...
            if select_time != 'all':
                ...
                if lsk != 'all':
                    ...
                    totals = {
                        ...
                        'total_c_amount': (agent_games_total['total_c_amount'] or 0) + (dealer_games_total['total_c_amount_admin'] or 0),
                        'total_d_amount': (agent_games_total['total_d_amount'] or 0) + (dealer_games_total['total_d_amount_admin'] or 0)
                    }
